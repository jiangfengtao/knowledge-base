...
async function main() {
  ...
  await prisma.userSettings.create({
    data: {
      userId,
      settings: JSON.stringify({ theme: "default", editorFont: "system", editorFontSize: 16 }),
    },
  }).catch(() => {
  ...
  console.log(`[seed] Summary: 1 user, 7+1 root KBs, 12 categories, 29 subcategories, ${docCount} docs, ${tagNames.length} tags, ${noteCount} notes`);
